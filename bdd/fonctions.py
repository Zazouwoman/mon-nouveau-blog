...
def creer_pdf_facture_par_dossier(facture,affaire,offre,ingeprev,dossier):
    """Crée le fichier pdf de la facture dans le dossier PRIVE
    Donnée nécessaire : obj,dossier"""
    ...
    fichier2 = DOSSIER_PRIVE + 'facturation_par_dossier/{}/{}.pdf'.format(facture.Num_Affaire(), facture.Numero_Facture)
